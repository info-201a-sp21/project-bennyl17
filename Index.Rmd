...
##  Chart Script 2
```{r plot, echo = FALSE}
covid_deaths(covid_df)
```

For our second chart script we wanted to use it to analyze the amount of covid cases and deaths around the world. With this ordinal data, we thought it would be best to represent it with a position visualization. We organized the plot to represent the amount of cases, and deaths in each continent. The plot addressed the question of "Which continent had the highest cases to deaths ratio?" And by looking at which continent had the steepest slope. Although Asia might be the continent with the most cases, we can see that South America had the greatest cases to deaths ratio.
