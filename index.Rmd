...
For our first chart script we chose to do it about what day is most common to get the vaccine within the USA. We used the data set from this [website](https://www.kaggle.com/paultimothymooney/usa-covid19-vaccinations). We chose to do it in a bar chart because it was a good way of seeing which day triumphs another. We included this as a way for the audience to see which days are the busiest according to our data set and maybe they can avoid those days to reduce waiting times and potentially save them time. It seems that most days, there is about the same amount of people getting vaccinated each day of the week but Sunday seems to be slightly less than all the others.
